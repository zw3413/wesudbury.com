        ...
        <div className="container mx-auto px-4 py-8 flex flex-col min-h-screen bg-[rgb(250,252,255)]">
            <main className="flex-grow">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-center relative">
                    {/* <span className="text-[rgb(40,76,96)]">{t('welcome')} </span> */}
                    <span className="relative inline-block">
                        ...
                        <span className="text-[rgb(40,76,96)]">Sudbury</span><span className="text-lg text-[rgb(40,76,96)]">.com</span>
                    ...
                    <span className="absolute -bottom-6 -right-6 text-9xl text-[rgb(40,76,96)] opacity-10 font-extrabold">Sudbury</span>
                </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    <section className="bg-[rgb(245,247,250)] rounded-lg shadow-md p-6">
                        <h2 className="text-2xl font-bold mb-4 text-[rgb(40,76,96)]">{t('lifestyle.title')}</h2>
                    ...
                    <section className="bg-[rgb(245,247,250)] rounded-lg shadow-md p-6">
                        <h2 className="text-2xl font-bold mb-4 text-[rgb(40,76,96)]">{t('rideshare.title')}</h2>
                    ...
                    <section className="bg-[rgb(245,247,250)] rounded-lg shadow-md p-6">
                        <h2 className="text-2xl font-bold mb-4 text-[rgb(40,76,96)]">{t('newcomer.title')}</h2>
                        <ul className="space-y-2">
                            <li>
                ...
                <section className="bg-[rgb(245,247,250)] rounded-lg shadow-md p-6 mb-12">
                    <h2 className="text-2xl font-bold mb-4 text-[rgb(40,76,96)]">{t('usefulLinks.title')}</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        <a href={t('usefulLinks.cityWebsite.url')} target="_blank" rel="noopener noreferrer" className="flex items-center p-3 bg-white rounded-lg hover:bg-[rgb(255,183,77)] hover:text-white transition-colors">
                            <svg className="w-6 h-6 mr-2 text-[rgb(40,76,96)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                        ...
                        <a href={t('usefulLinks.publicTransport.url')} target="_blank" rel="noopener noreferrer" className="flex items-center p-3 bg-white rounded-lg hover:bg-[rgb(255,183,77)] hover:text-white transition-colors">
                            <svg className="w-6 h-6 mr-2 text-[rgb(40,76,96)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" /></svg>
                        ...
                        <a href={t('usefulLinks.events.url')} target="_blank" rel="noopener noreferrer" className="flex items-center p-3 bg-white rounded-lg hover:bg-[rgb(255,183,77)] hover:text-white transition-colors">
                            <svg className="w-6 h-6 mr-2 text-[rgb(40,76,96)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                        ...
                        <a href={t('usefulLinks.emergencyServices.url')} target="_blank" rel="noopener noreferrer" className="flex items-center p-3 bg-white rounded-lg hover:bg-[rgb(255,183,77)] hover:text-white transition-colors">
                            <svg className="w-6 h-6 mr-2 text-[rgb(40,76,96)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" /></svg>
                ...
                {/* <section className="bg-[rgb(245,247,250)] rounded-lg p-6 mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white rounded-lg shadow-md p-4">
                            ...
                            <h3 className="text-xl font-semibold mb-2 text-[rgb(40,76,96)]">{t('featuredContent.title1')}</h3>
                        ...
                        <div className="bg-white rounded-lg shadow-md p-4">
                            ...
                            <h3 className="text-xl font-semibold mb-2 text-[rgb(40,76,96)]">{t('featuredContent.title2')}</h3>
