    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto bg-[rgb(245,247,250)] p-8 rounded-lg shadow-md">
            <div className="grid md:grid-cols-2 gap-6">
                <div>
                    <label htmlFor="from" className="block text-sm font-medium text-[rgb(40,76,96)]">{translations['from']}</label>
                ...
                <div>
                    <label htmlFor="to" className="block text-sm font-medium text-[rgb(40,76,96)]">{translations['to']}</label>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div>
                    <label htmlFor="date" className="block text-sm font-medium text-[rgb(40,76,96)]">{translations['date']}</label>
                ...
                <div>
                    <label htmlFor="time" className="block text-sm font-medium text-[rgb(40,76,96)]">{translations['time']}</label>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div>
                    <label htmlFor="seats" className="block text-sm font-medium text-[rgb(40,76,96)]">{translations['seats']}</label>
                ...
                <div>
                    <label htmlFor="maxPrice" className="block text-sm font-medium text-[rgb(40,76,96)]">{translations['maxPrice']}</label>
            ...
            <div>
                <label htmlFor="notes" className="block text-sm font-medium text-[rgb(40,76,96)]">{translations['notes']}</label>
